...
<p class="pl-3 f-21 cl-000000">Commission Fee</p>
<form action="{{ route('dashboard.fee.update',$fee->id) }}" method="post" id="client_profile_form">
    @csrf 
    @method('PUT')
    <div class="pl-5 pr-5 first-step-html-change">
        <div class="row justify-content-between">
            <div
                ...
                <div class="w-100">
                    <input type="text" class="w-100 form-control border-0" placeholder="Enter commission fee" name="fee"
                        id="username" aria-label=""
                        aria-describedby="basic-addon1" value="{{ $fee->fee }}" />
                </div>
            </div>
        </div>
