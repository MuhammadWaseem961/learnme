...
<body style="display:block !important;">
    ...
    <div class="d-none event-calling-div position-fixed  left-top-z-index" ><div class="A_D_div text-center bg-dark p-5 rounded"><h6 class="incoming-call text-white mb-4"></h6><div class="d-flex justify-content-center   rounded "><div class="ringing-bell"> <img class="end-call cursor-pointer faa-ring animated fa-5x" onclick="endCall()"  src="{{ asset('assets/frontend/images/decline.png') }}" alt="image" /></div class="ringing-bell"> <div><img class="faa-ring animated fa-5x cursor-pointer" data-event-id="" id="makeSellerEventCallDiv" onclick="makeSellerEventCall(this)" src="{{ asset('assets/frontend/images/accept.png') }}" alt="image" /></div></div> </div></div>
                    ...
                    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        @if(Auth::user()->type!='admin')
                            ...
                            @if (Auth::user()->type == 'seller')
                                ...
                                <a class="nav-link cl-000000 {{ Request::is('posts') ? 'active' : ''  }}"  href="{{ url('/posts') }}" >Posts</a>
                                <a class="nav-link cl-000000 {{ Request::is('user/events') ? 'active' : ''  }}"  href="{{ url('/user/events') }}" >Events</a>
                            @endif
                            ...
                            <a class="nav-link cl-000000 {{ Request::is('eventTickets') ? 'active' : ''  }}" href="{{ url('eventTickets') }}">Event Tickets</a>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer border-0">
                    @if(Auth::check() && Auth::user()->type=="seller")
                        <button type="button" class="btn btn-secondary bg-3ac574" onclick="againCall()">Again Call</button>
...
<!-- T E N    S E C T I O N  E N D  -->
    ...
    <!-- jQuery first, then Popper.js, then Bootstrap JS -->
        ...
        <script src="{{ asset('assets/admin/dist/js/firebase.js') }}"></script>
