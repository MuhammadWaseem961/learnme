    ...
    <div class="row m-0 justify-content-center">
        <div class="col-md-3 col-lg-3 col-sm-12 p-0 box_shadow1 borderRadius-12px pt-5 pb-5">
            ...
            <ul class="nav nav-tabs border-0 flex-column robotoRegular f-18 side_navpills-1 pt-4">
                ...
                <li class="pt-3 pb-3 mt-1 pl-4  bg-3ac574 active cl-ffffff appointment " data-toggle="tab"
                    href="#menu1">Appointments</li>
                <li class="pt-3 pb-3 mt-1 pl-4  " data-toggle="tab" href="#menu2" class="cl-616161">Favourites</li>
                <li class="pt-3 pb-3 mt-1 pl-4 " data-toggle="tab" href="#menu3" class="cl-616161">Account & Settings
                </li>
                ...
                <li class="pt-3 pb-3 mt-1 pl-4 " data-toggle="tab" href="#menu6" class="cl-616161">Like us on Facebook
                </li>
        ...
        <div class="col-md-7 col-lg-7 col-sm-12 p-0 ml-4 box_shadow1 borderRadius-12px">
            <div class="tab-content">
                ...
                <div id="menu1" class="tab-pane active ">
                    ...
                    <section class="p-100">
                        <div class="pt-4">
                            <div class="cl-3ac754 f-21 robotoRegular mt-4 mb-4 tilteContainerDashboard d-inline pb-1">
                                Appointments</div>
                        </div>
                    ...
                    <section class="p-100 ">
                        <div class="row pt-3 pb-3 mt-5 box_shadow1  ml-0 mr-0 borderRadius-10px justify-content-around">
                            <div class="text-center">
                                <p class="robotoRegular cl-515151 f-13 m-0">March</p>
                                <p class="f-45 m-0 cl-515151 robotoRegular">13</p>
                            ...
                            <div class="col-md-5 col-lg-5 p-0 d-flex justify-content-center flex-column ">
                                ...
                                <div class="d-flex">
                                    <div class="f-18 d-flex   align-items-center cl-000000 robotoRegular">Regular
                                        Cut-Recorte Regular</div>
                                    <div class="f-24 pl-2 cl-616161 robotoRegular">$30</div>
                                </div>
                            ...
                            <div class="text-center d-flex justify-content-center flex-column align-items-center">
                                ...
                                <div class="pt-3"> <button
                                        class="btn btn-outline-success my-2 my-sm-0 cl-ffffff bg-bbbbbb border-0 buttonBoxShadow pt-2 pb-2 robotoRegular pl-4 pr-4"
                                        type="submit">Book again</button></div>
                            </div>
                            <!-- end -->
                    ...
                    <section class="p-100 ">
                        <div class="row pt-3 pb-3 mt-4 box_shadow1  ml-0 mr-0 borderRadius-10px justify-content-around">
                            ...
                            <div class="text-center d-flex justify-content-center flex-column align-items-center">
                                <div class="robotoRegular cl-616161">Pending</div>
                                <div class="pt-3"> <button
                                        class="btn btn-outline-success my-2 my-sm-0 cl-ffffff bg-3ac574 border-0 buttonBoxShadow pt-2 pb-2 robotoRegular pl-4 pr-4"
                                        type="submit">Book again</button></div>
                            </div>
                            <!-- end -->
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body d-flex align-items-center flex-column justify-content-center pt-5">
                ...
                <div class="f-21 robotoRegular cl-3ac754 w-50 text-center">The host is currently meeting with other
                    client and will let you into
                    the meeting shortly.</div>
                <div class="f-21 robotoRegular pt-4">Average Wait:<span class="cl-3ac754 pl-3">Approx 5-10
                        Minutes</span></div>
            </div>
