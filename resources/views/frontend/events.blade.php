                        ...
                        <a href="{{ route('event_detail',$event->slug )}}">
                            <div class="shadow rounded" style="box-shadow: rgba(149, 157, 165, 0.2) 0px 8px 24px;">
                                ...
                                <div class="px-3 py-3">
                                    ...
                                    <h6 class="card-title text-dark m-0 robotoMedium cl-3ac754 pt-2"><span>By:</span> {{$event->user->username}}</h6>
                                    <div class="py-1 d-flex align-items-center "> <h6 class="card-title text-dark m-0 robotoMedium cl-3ac754 pt-2"><span>Reviews:</span></h6> <img class="ml-2 pt-2" src="{{ asset('assets/frontend/images/rating/'.explode(".",$event->user->rating)[0].'.png') }}" width="100" alt="" srcset=""></div>
                                    ...
                                    <div class="pt-3"><a href="{{ route('event_detail',$event->slug )}}" class="learnMoreButton w-100 px-5 py-1 btn robotoRegular" >Learn More</a></div>
                                </div>
                            </div>
                        </a>
                    </div>
