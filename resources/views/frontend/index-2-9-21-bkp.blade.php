                                ...
                                <div class="col-sm-12 col-xs-12">
                                    <a href="{{route('specialist_detail',$specialist->username)}}">
                                        <div class="our-team rounded"
                                            style="box-shadow: rgba(149, 157, 165, 0.2) 0px 8px 24px;">
                                            <div class="pic">
                                                <img src="{{ ($specialist->thumbnail != null) ? fopen($specialist->thumbnail,'r')?asset($specialist->thumbnail):asset('uploads/user/default.jpg'): asset('uploads/user/default.jpg') }}"
                                                    alt="">
                                            </div>
                                            <div class="team-contenT">
                                                <h3 class="title RobotoMedium">{{ $specialist->username }}</h3>
