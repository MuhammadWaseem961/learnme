                    ...
                    @foreach ($pending as $key => $appointment) 
                        ...
                        <tr class="border-0">
                            <td class=" border-0">
                                {{-- <section class="p-100"> --}}
                                <section>
                                    <div class="row flex-directionSmall pt-3 pb-3  box_shadow1 ml-0 mr-0 borderRadius-10px justify-content-around">
                                        ...
                                        <!-- 2 -->
                                        <div class="col-md-5 linear_flex  col-lg-5 p-0 d-flex justify-content-center align-items-start flex-column">
                                            ...
                                            @if ($appointment->state != "3") 
                                                @if (Auth::user()->type=='seller')
                                                    ...
                                                    {{-- <div class="pt-3">
                                                        <form action="{{ route('appointments.update',$appointment->id) }}" method="post">
                                                            @csrf @method('put')
                                                            <input type="hidden" name="status" value="{{ $appointment->state == '2'? '1': ($appointment->state == '0'? '1':'3') }}" />
                                                            <button type="submit" class="btn btn-outline-success my-2 my-sm-0 cl-ffffff bg-3AC574 border-0 buttonBoxShadow pt-2 pb-2 robotoRegular pl-4 pr-4">
                                                                {{ $appointment->state == '2'? 'Accept': ($appointment->state == '0'? 'Accept':'Completed') }}
                                                            </button>
                                                        </form>
                                                    </div> --}}
                                                @endif 
                                                    ...
                                                    @else
                                                        <div class="pt-3">
                                                            ...
                                                            <button
                                                                ...
                                                                data-specialist="{{ $appointment->seller_id }}"
                                                                data-amount="{{ $appointment->service_cost - $appointment->payment_amount }}"
                                                ...
                                                <div class="pt-3">
                                                   <button type="button" onclick="bookingReject('{{ $appointment->id }}')" class="btn btn-outline-success my-2 my-sm-0 cl-ffffff bg-bbbbbb border-0 buttonBoxShadow pt-2 pb-2 robotoRegular pl-4 pr-4">Decline</button>
                                                </div>
                                            @endif
                                        </div>
                                        <!-- end -->
                    ...
                    @foreach ($approved as $key => $appointment) 
                        ...
                        <tr class="border-0">
                            <td class=" border-0">
                                {{-- <section class="p-100"> --}}
                                <section>
                                    <div class="row pt-3 pb-3 flex-directionSmall  box_shadow1 ml-0 mr-0 borderRadius-10px justify-content-around">
                                        <div class="text-center">
                                            <p class="robotoRegular cl-515151 f-13 m-0">
                                                @if(Auth::user()->type=='buyer')
                                                    {{\Carbon\Carbon::createFromFormat('Y-m-d H:i:s', date('Y-m-d h:i:s',$appointment->service_date/1000))->format('F')}} 
                                        ...
                                        <div class="text-center d-flex justify-content-center flex-column align-items-center">
                                            @if (Auth::user()->type=='seller')
                                                ...
                                                @elseif($appointment->paystate == "1" && $appointment->state=="2")
                                                    ...
                                                    <div class="pt-3 d-none seller-video-chat-img-{{ $appointment->id }}"><button class="btn btn-success my-2 my-sm-0 cl-ffffff bg-bbbbbb border-0 buttonBoxShadow pt-2 pb-2 robotoRegular pl-4 pr-4 video-chat"  onclick="makeCall(this)" data-booking-id="{{ $appointment->id }}" data-id="{{ $appointment->id }}" data-sender="{{ $appointment->specialist->id }}" data-reciever="{{ $appointment->user->id }}" id="video-chat" data-toggle="modal" data-target="#video-call-modal" data-caller="{{$appointment->user->username}}">Enter</button></div>
                                                @else
                                                    <div class="pt-3">
                                                        <button type="button" onclick="bookingReject('{{ $appointment->id }}')" class="btn btn-success my-2 my-sm-0 cl-ffffff bg-3AC574 border-0 buttonBoxShadow pt-2 pb-2 robotoRegular pl-4 pr-4">Cancel Request</button>
                                                    </div>
                                                @endif
                                            @endif 
                                            ...
                                            @elseif(Auth::user()->type=='buyer' && $appointment->paystate == "1" && $appointment->state == "2" )
                                                ...
                                                <div class="pt-3 d-none buyer-video-chat-img-{{ $appointment->id }}"><button class="btn btn-success my-2 my-sm-0 cl-ffffff bg-bbbbbb border-0 buttonBoxShadow pt-2 pb-2 robotoRegular pl-4 pr-4 video-chat"  onclick="makeCall(this);" data-booking-id="{{ $appointment->id }}" data-sender="{{ $appointment->user->id }}" data-reciever="{{ $appointment->specialist->id }}" data-id="{{ $appointment->id }}" id="client-video-chat" data-toggle="modal" data-target="#video-call-modal" data-caller="{{$appointment->specialist->username}}">Enter</button></div>
                                                <div class="pt-3">
                                                    <form action="{{ route('appointments.update',$appointment->id) }}" method="post">
                                                        @csrf @method('put')
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body" style="text-align: start" >
                                                                <form id="add-review-form-{{$appointment->id}}">
                                                                    ...
                                                                    <button type="button" class="btn btn-sm btn-success ml-4" onclick="add_review(this);" data-id="{{$appointment->id}}">Add</button>
                                                                </form>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <button class="btn btn-outline-success my-2 cl-ffffff bg-3AC574 border-0 buttonBoxShadow pt-2 pb-2 robotoRegular pl-4 pr-4" data-toggle="modal" data-target="#review_modal{{$appointment->id}}"
