...
<a  href="{{ url('addPosts') }}" title="Click to Add Service" data-toggle="modal" data-target="#addServiceModal"
    class="btn btn-sm bg-3AC574 text-white m-2 add_service" style="float: right;"> Posts</a>
<div class="table-responsive ServiceTableData px-3" id="ServiceTableData">
    <table id="example1" class="table table-hover example1" style="width:100%;">
        ...
        <tbody>
            <tr>
                <td class="h5 m-0 va-middle">1</td>
                <td class="va-middle">Lorem ipsum dolor</td>
                <td class="va-middle"><img src="{{ asset('assets/frontend/images/19uk2-superdry-men-maroon-printed-round-neck-sports-t-shirt_500x500_0.png') }}"
                        width="70"></td>
                <td class="va-middle">Lorem ipsum dolor sit amet consectetur adipisicing elit. Debitis maxime harum placeat</td>
                <td class="va-middle">
                    <div class="d-flex">
                        <div><i class="fa fa-pencil-square-o" aria-hidden="true"></i></div>
                        <div class="pl-2"><i class="fa fa-trash-o" aria-hidden="true"></i></div>
                    </div>
                </td>
            </tr>
