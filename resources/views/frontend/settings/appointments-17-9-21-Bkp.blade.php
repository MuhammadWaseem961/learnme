                                                    ...
                                                    @if (Auth::user()->type=='buyer' && $appointment->paystate != "1")
                                                        ...
                                                        @else
                                                            <div class="pt-3">
                                                                ...
                                                                <a href="{{route('appointmentPayment',$appointment->id)}}" class="btn payment_btn btn-outline-success my-2 my-sm-0 cl-ffffff bg-3AC574 border-0 buttonBoxShadow pt-2 pb-2 robotoRegular pl-4 pr-4">
                                                                    Payment
                                                                </a>
                                                            </div>
                                                        @endif
                                        ...
                                        <div class="row pt-3 pb-3 flex-directionSmall  box_shadow1 ml-0 mr-0 borderRadius-10px justify-content-around">
                                            ...
                                            <div class="text-center d-flex justify-content-center flex-column align-items-center">
                                                @if (Auth::user()->type=='seller')
                                                    ...
                                                    @else
                                                        <div class="pt-3">
                                                            <button type="button" onclick="bookingReject('{{ $appointment->id }}')" class="btn btn-success my-2 my-sm-0 cl-ffffff bg-3AC574 border-0 buttonBoxShadow pt-2 pb-2 robotoRegular pl-4 pr-4">Decline</button>
                                                        </div>
                                                    @endif
                                                @endif 
                                                ...
                                                @if (Auth::user()->type=='buyer' && ($appointment->paystate == "0" || $appointment->paystate==null) )
                                                    <div class="pt-3">
                                                        <p class="f-12 robotoRegular m-0">Specialist Accepted <br> pay now to confirm Appointment</p>
                                                        <a href="{{route('appointmentPayment',$appointment->id)}}" class="btn payment_btn btn-outline-success my-2 my-sm-0 cl-ffffff bg-3AC574 border-0 buttonBoxShadow pt-2 pb-2 robotoRegular pl-4 pr-4">Payment</a>
                                                    </div>
