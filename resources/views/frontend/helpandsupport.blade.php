...
<section class="container mb-5 py-5" style="width: 80%;margin: auto;padding-top: 30px;">
  ...
  <div class="py-5" style=" 
    ...
    text-align: center;
    margin: auto;
}"> <div style="   font-size: 37px;">	I am open to you creating something simple for this. </div>

<div style="    font-size: 33px;
    max-width: 786px;
    text-align: center;
    margin: auto;
}">But the most important things want to note that we are available 24/7 and the address is <a href="">support@learnme.live</a></div>
</div>      
        </section>
    </div>
</section>
