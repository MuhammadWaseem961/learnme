...
@if($comments->count()>0)
    @foreach($comments as $comment)
        ...
        <div class="d-flex flex-directionSmall my-5">
            <div class="img_commentSection w-10"><img src="{{ asset($comment->user->picture) }}" class="w-75 border-radius-50" onerror="this.error=null; this.src='{{asset('uploadfiles/userphoto/default.jpg')}}'"></div>
