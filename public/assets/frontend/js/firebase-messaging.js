!(function (e, t) {
    ...
    try {
        !function () {
                ...
                return (
                    r &&
                        (r.onupgradeneeded = function (e) {
                            n &&
                                n(new D(r.result, e.oldVersion, r.transaction));
                        }),
                    t.then(function (e) {
                        return new j(e);
                    })
            ...
            m(T, "_index", ["name", "keyPath", "multiEntry", "unique"]),
                k(T, "_index", IDBIndex, [
                    "get",
                    "getKey",
                    "getAll",
                ...
                I(T, "_index", IDBIndex, ["openCursor", "openKeyCursor"]),
                m(C, "_cursor", ["direction", "key", "primaryKey", "value"]),
                k(C, "_cursor", IDBCursor, ["update", "delete"]),
                ...
                ["openCursor", "openKeyCursor"].forEach(function (i) {
                    [_, T].forEach(function (e) {
                        i in e.prototype &&
                            (e.prototype[i.replace("open", "iterate")] =
                                function () {
                                    var e =
                                            ((n = arguments),
            ...
            function F(e) {
                return {
                    ...
                    requestStatus: 2,
                    expiresIn:
                        ((e = e.expiresIn), Number(e.replace("s", "000"))),
            ...
            function Y() {
                try {
                    ...
                    e = (function (e) {
                        return btoa(
                            String.fromCharCode.apply(String, i([], n(e)))
                        )
                            .replace(/\+/g, "-")
                            .replace(/\//g, "_");
                    })(e).substr(0, 22);
                            ...
                            case 0:
                                return [
                                    ...
                                    pe(i, function (e) {
                                        ...
                                        return (
                                            (t = e.registrationPromise),
                                            e.installationEntry
                                        );
                                    }),
                                ];
                            case 1:
                                return (n = e.sent()).fid !== J
                                    ? [3, 3]
                                    : ((r = {}), [4, t]);
                            case 2:
                                return [
                                    2,
                                    ((r.installationEntry = e.sent()), r),
                                ];
                            case 3:
                                return [
                                    2,
            ...
            function ye(e) {
                return pe(e, function (e) {
                    ...
                    var t = e.authToken;
                    return 1 === (t = t).requestStatus &&
                        t.requestTime + K < Date.now()
                        ? p(p({}, e), { authToken: { requestStatus: 0 } })
                        : e;
                });
            }
            function we(e) {
            ...
            ((R = Te = Te || {}).PUSH_RECEIVED = "push-received"),
                        ...
                        switch (e.label) {
                            ...
                            case 4:
                                if ((t = e.sent()).error)
                                    throw (
                                        ((n = t.error.message),
                                        Ce.create("token-unsubscribe-failed", {
                                            errorInfo: n,
                                        }))
                                    );
                                return [3, 6];
                        ...
                        switch (e.label) {
                            case 0:
                                if ("granted" !== Notification.permission)
                                    throw Ce.create("permission-blocked");
                                return [
                                    4,
                                    (function (n, r) {
                                        return d(
                            ...
                            case 3:
                                if (
                                    ((t = s.subscriptionOptions),
                                    (r = (n = a).vapidKey === t.vapidKey),
                                    (i = n.endpoint === t.endpoint),
                                    (o = n.auth === t.auth),
                                    (t = n.p256dh === t.p256dh),
                                    r && i && o && t)
                                )
            ...
            function Ye(e) {
                var t = { from: e.from, collapseKey: e.collapse_key };
                return (
                    (function (e, t) {
            ...
            var Xe =
                (Object.defineProperty(et.prototype, "app", {
                    get: function () {
                ...
                (et.prototype.setBackgroundMessageHandler = function (e) {
                    if (
                        ...
                        throw Ce.create("invalid-bg-handler");
                ...
                (et.prototype.usePublicVapidKey = function (e) {
                    if (null !== this.vapidKey)
                        throw Ce.create("use-vapid-key-after-get-token");
                    if ("string" != typeof e || 0 === e.length)
                        throw Ce.create("invalid-vapid-key");
                    this.vapidKey = e;
                }),
                    ...
                    return d(this, void 0, void 0, function () {
                        ...
                        return h(this, function (e) {
                            switch (e.label) {
                                ...
                                case 3:
                                    return !0 === o &&
                                        !1 === this.isOnBackgroundMessageUsed
                                        ? [2]
                                        : (this.bgMessageHandler &&
                                              ((s = Ye(s)),
                                              "function" ==
                                              typeof this.bgMessageHandler
                                                  ? this.bgMessageHandler(s)
                                                  : this.bgMessageHandler.next(
                                                        s
                                                    )),
                                          [4, Qe(1e3)]);
                                case 4:
            ...
            var nt =
                (Object.defineProperty(rt.prototype, "app", {
                    get: function () {
                        return this.firebaseDependencies.app;
                    },
                    enumerable: !1,
                    ...
                    return d(this, void 0, void 0, function () {
                        return h(this, function (e) {
                            return (
                                t
                                    ? (this.vapidKey = t)
                                    : this.vapidKey || (this.vapidKey = _e),
                                [2]
                            );
                        });
                    });
                            ...
                            switch (e.label) {
                                ...
                                case 1:
                                    if ("granted" === (t = e.sent()))
                                        return [2];
                                    throw "denied" === t
                                        ? Ce.create("permission-blocked")
                                        : Ce.create("permission-default");
                            }
                        });
                    });
                }),
                ...
                (rt.prototype.useServiceWorker = function (e) {
                    if (!(e instanceof ServiceWorkerRegistration))
                        throw Ce.create("invalid-sw-registration");
                    if (this.swRegistration)
                        throw Ce.create("use-sw-after-get-token");
                                    ...
                                    return (
                                        e
                                            ...
                                            .logEvent(t, {
                                                ...
                                                message_time:
                                                    r["google.c.a.ts"],
                                                message_device_time: Math.floor(
                                                    Date.now() / 1e3
                                                ),
                                            }),
                                        [2]
            ...
            function it(e) {
                return Ce.create("missing-app-config-values", { valueName: e });
            }
            R = { isSupported: ot };
            function ot() {
            ...
            t.default.INTERNAL.registerComponent(
                new g(
                    ...
                    function (e) {
                        var t = e.getProvider("app").getImmediate(),
                            e = {
                                ...
                                appConfig: (function (e) {
                                    var t, n;
                                    if (!e || !e.options)
                                        throw it("App Configuration Object");
                        ...
                        return new (
                            self && "ServiceWorkerGlobalScope" in self ? Xe : nt
                        )(e);
                    },
                    "PUBLIC"
                ).setServiceProps(R)
